...
// 8개 봇의 목표 거리(m) 스펙트럼 — GHOST_TOP_N=8. 상위 절반이 3~8천m 장거리 커버.
// 실제 목표는 시드별 ±15% 지터 → 데일리 보드마다 분포가 살짝 다르다.
const BOT_TARGETS_M = [250, 700, 1400, 2400, 3500, 4800, 6200, 7800] as const;
...
/**
 * 8개 봇을 "초반 사망 ~ 장거리(3~8천m)"까지 스펙트럼으로 생성한다 (GHOST_TOP_N=8).
